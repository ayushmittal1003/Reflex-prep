          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left text-white mb-8 lg:mb-0">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 max-w-xs sm:max-w-md mx-auto lg:mx-0 px-2 sm:px-0">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-2 sm:p-3 text-center">
                <div className="text-sm sm:text-lg font-bold text-white mb-0.5">50K+</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-2 sm:p-3 text-center">
                <div className="text-sm sm:text-lg font-bold text-white mb-0.5">2K+</div>
                ...
                <div className="bg-white rounded-2xl overflow-hidden h-[400px] sm:h-[500px] w-52 sm:w-64 relative">
                  <div className="absolute inset-0 flex flex-col">
                    <div className="bg-teal-500 text-white p-3 sm:p-4">
                      ...
                      <div className="text-xs sm:text-sm opacity-80">10,000+ PYQs</div>
                    </div>
                    <div className="flex-1 bg-white p-2 sm:p-3">
                      <div className="bg-gray-100 rounded-lg p-3 mb-3">
                        ...
                        <div className="mt-2 text-xs sm:text-sm text-gray-700">A 45-year-old male presents with...</div>
                        <div className="mt-3 space-y-2">
                          <div className="bg-white p-1.5 sm:p-2 rounded border border-gray-200 text-xs sm:text-sm">A. Treatment 1</div>
                          <div className="bg-white p-1.5 sm:p-2 rounded border border-gray-200 text-xs sm:text-sm">B. Treatment 2</div>
                          <div className="bg-teal-50 p-1.5 sm:p-2 rounded border-2 border-teal-500 text-xs sm:text-sm">C. Treatment 3</div>
                          <div className="bg-white p-1.5 sm:p-2 rounded border border-gray-200 text-xs sm:text-sm">D. Treatment 4</div>
                        </div>
                      </div>
